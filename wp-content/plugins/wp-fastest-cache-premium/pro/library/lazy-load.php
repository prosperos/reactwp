<?php
	...
	class WpFastestCacheLazyLoad{
		...
		public function is_exclude($source){
			...
			<img data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="8" class="rev-slidebg" data-no-retina>
			*/
			if(preg_match("/class\=\"rev-slidebg\"/i", $source) && preg_match("/data-bgposition\=/i", $source)){
				return true;
			}
